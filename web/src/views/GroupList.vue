<template>
  <div class="h-full flex flex-col space-y-6">
    ...
    >
      ...
      <button @click="fetchGroups" class="text-red-600 hover:text-red-800 underline ml-auto">
        重试
      </button>
    </div>
            ...
            <tr v-for="group in groups" :key="group.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <span
                  ...
                  :class="getStrategyClass(group.strategy)"
                >
      ...
      <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div class="px-6 py-4 space-y-6">
          ...
          <div>
            ...
            <div
              v-if="groupDetail?.hosts?.length === 0"
...
const addHost = async () => {
  ...
  try {
    await api.post(`/groups/${groupDetail.value.id}/hosts`, {
      host_id: parseInt(selectedHostId.value),
    })
    closeAddHostModal()
