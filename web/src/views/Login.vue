<template>
  <div
    class="min-h-viewport bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center p-4"
  >
    <div class="w-full max-w-md">
      ...
      <div class="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 p-8">
        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <div
            v-if="error"
            class="bg-red-500/20 border border-red-500/30 rounded-lg p-3 flex items-center"
          >
            <svg
      ...
      <!-- 底部版权 -->
      <p class="text-center text-blue-300/60 text-xs mt-6">SSH Port Forwarder v1.0</p>
    </div>
  </div>
</template>
